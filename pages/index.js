...
const getAuthorization = () => {
  ...
  return (
    axios
      .put(
        `https://api.login.yahoo.com/oauth2/request_auth?client_id=${client_id}&redirect_uri=https%3A%2F%2Fblahffblah.herokuapp.com/t%3A3000&response_type=code&language=en-us`
